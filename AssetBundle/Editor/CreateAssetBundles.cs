...
public class CreateAssetBundles : EditorWindow
{
	...
	void BuildAllAssetBundles()
	{
		...
		BuildPipeline.BuildAssetBundles(assetBundleDirectory,bundles,BuildAssetBundleOptions.UncompressedAssetBundle, EditorUserBuildSettings.activeBuildTarget);
	}
}
